...
const AddLead: React.FC<AddLeadProps> = ({ onAddLead, onCancel }) => {
  ...
  const handleInterviewerChange = (event: React.SyntheticEvent, newValue: string[]) => {
    setFormData({ ...formData, Interviewer: newValue });
  };
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} label="Interviewer" placeholder="Type and press enter" />
                )}
